...
class TravelingSalesmanProblem:
    ...
    def __initData(self):
        ...
        try:
            self.locations = pickle.load(
                open(os.path.join("tsp/tsp-data", self.name + "-loc.pickle"), "rb")
            )
            self.distances = pickle.load(
                open(os.path.join("tsp/tsp-data", self.name + "-dist.pickle"), "rb")
            )
    ...
    def __createData(self):
        ...
        with open("tsp/tsp-data/" + self.name + ".tsp", "rb") as f:
            reader = csv.reader(
